    ...
    return (
        <div className="h-full flex flex-col justify-center space-y-4">
            <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-semibold text-slate-700 dark:text-slate-200">ROI Simulator</h4>
            </div>
            
            <div className="space-y-4">
                <div>
                    <label className="block text-xs font-medium text-slate-500 mb-1">Initial Investment (R$)</label>
                    <input 
                        type="number" 
                        value={amount}
                ...
                <div>
                    ...
                    />
                    <div className="text-right text-xs text-slate-500 mt-1">{months} months</div>
                </div>
                ...
                <div className="bg-indigo-50 dark:bg-indigo-900/30 p-4 rounded-lg border border-indigo-100 dark:border-indigo-800/50">
                    <div className="flex justify-between items-center mb-1">
                        <span className="text-sm text-indigo-700 dark:text-indigo-300">Total Return</span>
                    ...
                    <div className="flex justify-between items-center">
                        <span className="text-xs text-indigo-500 dark:text-indigo-400">Profit</span>
                ...
                <p className="text-[10px] text-slate-400 text-center">
                    *Hypothetical projection using constant current Selic rate ({currentRate}%). Not financial advice.
                </p>
            </div>
        </div>
    );
